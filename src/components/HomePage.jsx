...
function HomePage() {
  return (
    <div className="h-screen overflow-hidden max-h-[900px] w-full relative place-items-center sm:h-[100vh] flex flex-col justify-center pt-20 backdrop-blur-sm">
      ...
      <div className="w-32 h-80 rotate-[-40deg] bg-purple-500 absolute top-10 left-[-20px] z-[-8] blur-3xl opacity-40"></div>
      <div className="hidden: w-40 h-52 rotate-[-40deg] bg-purple-500 absolute top-12 right-[25%] z-[-8] blur-[70px] opacity-30 "></div>
